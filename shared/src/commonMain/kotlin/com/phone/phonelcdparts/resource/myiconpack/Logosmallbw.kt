...
public val MyIconPack.Logosmallbw: ImageVector
    get() {
        if (_logosmallbw != null) {
            return _logosmallbw!!
        }
        _logosmallbw = Builder(name = "Logosmallbw", defaultWidth = 69.0.dp, defaultHeight =
                69.0.dp, viewportWidth = 69.0f, viewportHeight = 69.0f).apply {
...
private var _logosmallbw: ImageVector? = null
