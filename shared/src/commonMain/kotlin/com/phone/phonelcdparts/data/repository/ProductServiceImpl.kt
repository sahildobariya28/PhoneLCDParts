...
class ProductServiceImpl() : ProductService {
    ...
    override suspend fun getProducts(): Pair<List<ProductDTO>, HttpStatusCode?> {
    ...
    override suspend fun getProductsByName(searchText: String, page: Int): Pair<List<ProductDTO>, HttpStatusCode?> {
        return try {
            val response = client.get {
    ...
    private fun parseProduct(json: String): List<ProductDTO> {

        val listTest = mutableListOf<ProductDTO>()
